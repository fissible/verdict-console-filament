...
> **Status: repository stood up, package not yet scaffolded.** The plugin scaffold and Resources
> are tracked in this repository's v0.1.0 milestone. Design of record: verdict-console
